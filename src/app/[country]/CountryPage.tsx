...
export default function CountryPage({
  ...
  return (
    ...
    <div className="bg-gray-50 pt-12 pb-12">
      <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
    <section id="overview" className="scroll-mt-[136px]">
    ...
    <div className="bg-white py-12">
      <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
    <section id="visa" className="scroll-mt-[136px]">
    ...
    <div className="bg-gray-50 py-12">
      <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
    <section id="money" className="scroll-mt-[136px]">
    ...
    <div className="bg-white py-12">
      <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
    <section id="communications" className="scroll-mt-[136px]">
            ...
            <div className="mt-6">
              <dl className="divide-y divide-gray-100">
                ...
                {phoneInfo.how_to_dial_international && (
                  <div className="px-4 py-4 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                    <dt className="text-sm font-medium text-gray-900">Dial from Abroad</dt>
    ...
    <div className="bg-gray-50 py-12">
      <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
    <section id="time" className="scroll-mt-[136px]">
    ...
    <div className="bg-white py-12">
      <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
    <section id="transport" className="scroll-mt-[136px]">
      ...
      {driving && (driving.driving_side || driving.idp_required || driving.road_conditions) && (
        <div className="mt-12">
          ...
          <div className="mt-3 overflow-hidden rounded-lg bg-gray-50 ring-1 ring-gray-200">
            {/* Row 1: Drives On + International Driving Permit — two columns */}
            {(driving.driving_side || driving.idp_required) && (
              <div className="grid grid-cols-3 divide-x divide-gray-200">
                {driving.driving_side && (
                  <div className="col-span-1 px-4 py-5 sm:p-6">
                ...
                {driving.idp_required && (
                  <div className="col-span-2 px-4 py-5 sm:p-6">
    ...
    <div className="bg-gray-50 py-12">
      <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
    <section id="electrical" className="scroll-mt-[136px]">
    ...
    <div className="bg-white py-12">
      <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
    <section id="weather" className="scroll-mt-[136px]">
    ...
    <div className="bg-gray-50 py-12">
      <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
    <section id="measurements" className="scroll-mt-[136px]">
    ...
    <div className="bg-white py-12">
      <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
    <section id="emergency" className="scroll-mt-[136px]">
